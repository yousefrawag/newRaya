...
const dealyReport = require("../../model/brokerDeailyReports")
...
const addCsutomerBroker = async (req, res, next) => {
  ...
  customer.moduleType ="customer"
      ...
      await customer.save();
      console.log("customer-section-flow" , customer.SectionFollow)
         const delayData = {
              ReportType:"إضافة عميل",
                ReportTypeDescriep:req.body.SectionFollow?.ReportTypeDescriep || "متابعة" ,
...
module.exports = addCsutomerBroker;
